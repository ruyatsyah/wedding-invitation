        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {POSTS.map((post, i) => (
            ...
            >
              ...
              <div className="h-48 bg-gradient-to-br from-neutral-50 to-gray-100 flex items-center justify-center">
                <span className="text-4xl opacity-30">🌸</span>
              </div>

              <div className="p-6 flex flex-col flex-1">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-[#000000] bg-neutral-50 px-2.5 py-1 rounded-full">
                    {post.tag}
                  </span>
